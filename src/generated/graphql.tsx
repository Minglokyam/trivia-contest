...
/**
 * __useIncrementPointMutation__
 *
 * To run a mutation, you first call `useIncrementPointMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useIncrementPointMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [incrementPointMutation, { data, loading, error }] = useIncrementPointMutation({
 *   variables: {
 *      incrementPoints: // value for 'incrementPoints'
 *      id: // value for 'id'
 *   },
 * });
 */
export function useIncrementPointMutation(baseOptions?: Apollo.MutationHookOptions<IncrementPointMutation, IncrementPointMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<IncrementPointMutation, IncrementPointMutationVariables>(IncrementPointDocument, options);
      }
export type IncrementPointMutationHookResult = ReturnType<typeof useIncrementPointMutation>;
export type IncrementPointMutationResult = Apollo.MutationResult<IncrementPointMutation>;
export type IncrementPointMutationOptions = Apollo.BaseMutationOptions<IncrementPointMutation, IncrementPointMutationVariables>;
...
export const RegisterDocument = gql`
    mutation Register($options: CredentialOptions!) {
